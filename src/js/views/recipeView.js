...
const renderIngredient = ingredient => `
    <li class="recipe__item">
        ...
        <div class="recipe__count">${fractionCount(ingredient.count)}</div>
...
export const updateServingsIngredients  = recipe => {
    ...
    const ingredientCounts = document.querySelectorAll('.recipe__count')
    ingredientCounts.forEach((rc, i) => {
        rc.textContent = fractionCount(recipe.ingredients[i].count)
    })
}